...
@WebServlet("/coordinatorDefaulterList")
public class CoordinatorDefaulterServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<DefaulterRecord> defaulters = attendanceDAO.getDefaultersForCoordinator(teacher.getId(), threshold, startDate, endDate);
        ...
        request.getRequestDispatcher("coordinator_defaulters.jsp").forward(request, response);
    }
}
