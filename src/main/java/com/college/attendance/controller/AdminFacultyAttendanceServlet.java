...
public class AdminFacultyAttendanceServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            } else if ("verifyAllRecords".equals(action)) {
                Date targetDate = Date.valueOf(request.getParameter("targetDate"));
                dao.verifyAllAttendance(targetDate);
                com.college.attendance.dao.ActivityLogDAO.log(admin.getRole(), admin.getName(), "Verified all faculty attendance records for " + targetDate);
            } else {
