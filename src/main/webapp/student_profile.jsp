            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    <div class="profile-card text-center mb-4">
                        ...
                        <% if (photoUrl != null) { %>
                            <div class="mb-3">
                                <a href="studentProfile?action=remove_photo" class="btn btn-sm btn-outline-light text-white rounded-pill py-1 px-3 border border-light" style="font-size: 0.75rem; background: rgba(255,255,255,0.15);"><i class="bi bi-trash me-1"></i> Remove Photo</a>
                            </div>
                        <% } %>
