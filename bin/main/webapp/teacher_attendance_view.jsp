                                    ...
                                    <table class="table table-hover align-middle mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-end d-print-none" style="width: 30%">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <img src="https://ui-avatars.com/api/?name=<%= record.getStudentName() %>&background=e8e8e8&color=555&bold=true" 
                                                                 style="width: 32px; height: 32px; border-radius: 50%;" class="d-print-none">
                                                            <span class="fw-semibold"><%= record.getStudentName() %></span>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <% if(canEdit) { %>
                                                            <form action="teacherAttendanceView" method="post" class="d-flex justify-content-center align-items-center m-0 gap-2 d-print-none">
                                                            ...
                                                            <span class="d-none d-print-inline fw-bold <%= "Present".equals(record.getStatus()) ? "text-success" : "text-danger" %>"><%= record.getStatus() %></span>
                                                        <% } else { %>
                                                            <div class="radio-btn-group d-inline-flex gap-2 d-print-none">
