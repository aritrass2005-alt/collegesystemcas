                        ...
                        <div class="status-timeline">
                            ...
                            <div class="timeline-item <%= statusClass %>">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    ...
                                    <div>
                                        <span class="badge bg-<%= "pending".equals(statusClass) ? "warning text-dark" : ("approved".equals(statusClass) ? "success" : "danger") %> px-3 rounded-pill me-2">
                                            <%= l.getStatus() %>
                                        </span>
                                        <% if ("pending".equals(statusClass)) { %>
                                            <a href="studentLeave?action=cancel&id=<%= l.getId() %>" class="btn btn-sm btn-outline-danger py-0 px-2" style="font-size: 0.75rem;" onclick="return confirm('Are you sure you want to cancel this application?');">Cancel</a>
                                        <% } %>
                                    </div>
                                </div>
