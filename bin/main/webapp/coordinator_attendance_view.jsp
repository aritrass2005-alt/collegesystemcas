...
<html>
<head>
    <title>Attendance History - Coordinator</title>
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid p-0">
            ...
            <div class="card p-4 border-0 shadow-sm mb-4 d-print-none" style="border-radius: var(--card-radius);">
                ...
                <form action="coordinatorAttendanceView" method="get" class="row g-3 align-items-end">
                    <div class="col-md-5">
                                            ...
                                            %>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <% if(canEdit) { %>
                                                            <form action="coordinatorAttendanceView" method="post" class="d-flex justify-content-center align-items-center m-0 gap-2">
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <% } else { %>
                                                            <form action="coordinatorAttendanceView" method="post" class="m-0" onsubmit="return confirm('Are you sure you want to appeal to change this attendance record?');">
